...
def main():
    ...
    if args.fraction <= 0 or args.rotation_frames < 2 or args.fps < 1:
        parser.error("fraction must be >0, rotation-frames >=2, and fps >=1")
    ...
    if not args.no_rotation:
        ...
        with writer.saving(fig, gif, dpi=125):
